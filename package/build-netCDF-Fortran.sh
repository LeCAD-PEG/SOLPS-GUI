...
DOWNLOAD_LINK="https://github.com/Unidata/netcdf-fortran/archive/refs/tags/v${VERSION}.tar.gz"
...
CMAKE_FLAGS="${CMAKE_FLAGS} -DNETCDF_C_LIBRARY=${NCDIR}/lib/libnetcdf.so"
