...
from PySide6.QtWidgets import (QWidget, QSplitter, QTreeWidget, QTextBrowser,
...
class MyLineEdit(QLineEdit):
    ...
    Attributes:
        ...
        parameter_help (Signal): This is the signal that emits whenever a
            keyboard release or a mouse release event is occured.
    """
    parameter_help = Signal(str)
...
class CardEditDelegate(QStyledItemDelegate):
    ...
    Attributes:
        parameter_help (Signal): The signal responsible for help descrip-
            tion handling.
