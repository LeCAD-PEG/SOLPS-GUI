...
_tcsh_solps_scripts = [
    ...
    ('resmod', 'Selects residuals modulo #1 (default all \n'
        'power/particle losses (see section G and Appendix\n'
        '3.6.4 for the region definitions)'),
    ('b2stbc_sna_reg', 'Boundary particle sources for\n'
        'region #1 (default 0)'),
    ('b2stbr_sna_reg', 'Recycling particle sources for\n'
        'region #1 (default 0)'),
    ('b2stbm_sna_reg', 'Additional particle sources for\n'
        'region #1 (default 0)'),
    ('b2stbc_smo_reg', 'Boundary parallel momentum sources for\n'
        'region #1 (default 0)'),
    ('b2stbr_smo_reg', 'Recycling parallel momentum sources\n'
        'for region #1 (default 0)'),
    ('b2stbm_smo_reg', 'Additional parallel momentum sources\n'
        'for region #1 (default 0)'),
    ('rcxhireg', 'charge exchange energy for region #1\n'
        '(default 0)'),
    ('rcxnareg', 'charge exchange rate for region #1 (deflt 0)'),
    ('rqahereg', 'electron heat loss for region #1 (default 0)'),
    ('rqbrmreg', 'bremsstrahlung losses for region #1 (dflt 0)'),
    ('rqradreg', 'total radiation rate for region #1 (deflt 0)'),
    ('rrahireg', 'recombination energy for region #1 (deflt 0)'),
    ('rranareg', 'recombination rate for region #1 (default 0)'),
    ('rsahireg', 'ionization energy for region #1 (default 0)'),
    ('rsanareg', 'ionization rate for region #1 (default 0)'),
    ...
    ('xyplot8', 'alias for simple ”x y1 y2 y3 y4 y5 y6 y7 y8 plot'),
    ('xyplot9', 'alias for simple ”x y1 y2 y3 y4 y5 y6 y7 y8 y9 plot'),
