from PySide6.QtWidgets import (QWidget, QGraphicsView, QVBoxLayout, QApplication,
                             QLabel)
from PySide6.QtCore import (QSize, Signal, Slot, Property, QSettings,
                          Qt, QCoreApplication, QPoint, QRect, QDataStream,
                          QSizeF)
from PySide6.QtGui import QPainter, QColor, QResizeEvent, QPixmap, QCursor
...
class QtGnuplotWidget(QWidget, QtGnuplotEventReceiver):
    ...
    m_antialias = Property(bool, antialias, setAntialias)
    ...
    m_rounded = Property(bool, rounded, setRounded)
    ...
    m_replotOnResize = Property(bool, replotOnResize, setReplotOnResize)
    ...
    m_backgroundColor = Property(QColor, backgroundColor, setBackgroundColor)
    ...
    m_statusLabelActive = Property(bool, statusLabelActive, setStatusLabelActive)
