from PySide6.QtCore import (QSortFilterProxyModel, Qt, QSettings, Signal,
                          Slot, QModelIndex)
from PySide6.QtWidgets import (QTreeView, QStyle, QMessageBox,
