...
class PreferencesDialog(QDialog):
    ...
    def setPreferences(self):
        ...
        self.preferences.standalone = int(self.form.checkBox_standalone.checkState())
        self.preferences.use_mpi = int(self.form.checkBox_use_mpi.checkState())
        self.preferences.mpi_options = self.form.lineEdit_mpi_options.text()
        self.preferences.use_debugger = int(self.form.checkBox_use_debugger.checkState())
...
if __name__ == '__main__':
    ...
    class SOLPS_MainWindow(ui_class, widget_class):
        ...
        def on_actionDocumentation_triggered(self):
            ...
            p = Popen("env --unset LD_LIBRARY_PATH xdg-open ${HOME}/solps-gui/doc/build/html/index.html", shell=True, env=os.environ).wait()
