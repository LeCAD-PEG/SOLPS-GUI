...
class PreferencesDialog(QDialog):
    ...
    def setPreferences(self):
        ...
        self.preferences.standalone = int(self.checkBox_standalone.checkState().value)
        self.preferences.use_mpi = int(self.checkBox_use_mpi.checkState().value)
        self.preferences.mpi_options = self.lineEdit_mpi_options.text()
        self.preferences.use_debugger = int(self.checkBox_use_debugger.checkState().value)
        self.preferences.debugger = self.lineEdit_debugger.text()
        self.preferences.compress_log = int(self.checkBox_compress_log.checkState().value)
        self.preferences.dry_run = int(self.checkBox_dry_run.checkState().value)
        self.preferences.use_openmp = int(self.checkBox_use_openmp.checkState().value)
