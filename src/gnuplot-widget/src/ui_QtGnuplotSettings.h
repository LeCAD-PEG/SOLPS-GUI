...
public:
    ...
    {
        settingsDialog->setWindowTitle(QApplication::translate("settingsDialog", "Terminal configuration", Q_NULLPTR));
        backgroundButton->setText(QApplication::translate("settingsDialog", "Select background color", Q_NULLPTR));
        sampleColorLabel->setText(QApplication::translate("settingsDialog", "Sample", Q_NULLPTR));
        antialiasCheckBox->setText(QApplication::translate("settingsDialog", "Antialias", Q_NULLPTR));
        replotOnResizeCheckBox->setText(QApplication::translate("settingsDialog", "Replot on resize", Q_NULLPTR));
        roundedCheckBox->setText(QApplication::translate("settingsDialog", "Rounded line ends", Q_NULLPTR));
        label->setText(QApplication::translate("settingsDialog", "Mouse label", Q_NULLPTR));
        mouseLabelComboBox->clear();
        mouseLabelComboBox->insertItems(0, QStringList()
         << QApplication::translate("settingsDialog", "Status bar", Q_NULLPTR)
         << QApplication::translate("settingsDialog", "Tool bar", Q_NULLPTR)
         << QApplication::translate("settingsDialog", "Above plot", Q_NULLPTR)
