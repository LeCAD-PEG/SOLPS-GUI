...
class LineInputPlugin(QPyDesignerCustomWidgetPlugin):
    """LineInputPlugin(QPyDesignerCustomWidgetPlugin)
    ...
    def __init__(self, parent=None):
        ...
        super(LineInputPlugin, self).__init__(parent)
    ...
    def domXml(self):
        return '<widget class="LineInput" name="lineinput">\n' \
        '</widget>'
