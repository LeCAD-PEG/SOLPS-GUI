...
A Python script widget plugin for Qt Designer.
...
class ScriptWidgetPlugin(QDesignerCustomWidgetInterface):
    """ScriptWidgetPlugin(QDesignerCustomWidgetInterface)
    ...
    def __init__(self, parent=None):
        ...
        super(ScriptWidgetPlugin, self).__init__(parent)
