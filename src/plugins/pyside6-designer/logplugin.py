...
class LogPlugin(QDesignerCustomWidgetInterface):
    """LogPlugin(QDesignerCustomWidgetInterface)
    ...
    def __init__(self, parent=None):
        ...
        super(LogPlugin, self).__init__(parent)
    ...
    def createWidget(self, parent):
        return Log(parent, initiate=False)
