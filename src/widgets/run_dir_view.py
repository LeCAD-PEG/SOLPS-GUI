from PyQt5.QtCore import (Qt, QModelIndex, QThread, QSettings, QDateTime,
                          QAbstractItemModel, pyqtSignal, pyqtSlot, QSize,
                          QRect, QSortFilterProxyModel)
from PyQt5.QtWidgets import (QTreeView, QTreeWidgetItem, QStyle, QHeaderView,
...
from PyQt5.QtGui import QPen, QFontMetrics, QPainter
...
class RunsSortFilterProxyModel(QSortFilterProxyModel):
    ...
    def hasAcceptedChildren(self, sourceIndex):
        ...
        while items:
            ...
            if self.filterRegExp().indexIn(path) >= 0 and \
