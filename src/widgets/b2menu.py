...
#         or ( parametergroup, 'paramgroup', [(name, type, default, description)...], description)
  ...
  'Output': [ '',
      ...
      ( 'b2stbr_*_netcdf', 'switchgroup', [
         ...
         """
					...
					If balance_netcdf.ne.0, the file 'balance.nc' is created, which contains the 2-point model analysis balance tallies in CDF format.
				"""),
  ...
  'b2.neutrals.parameters': [ 'namelist',
         ...
         ( 'EB2SPCR', 'integer array of size (NATM)', 'first B2 species of each isonuclear sequence', """
         ...
         ( 'LSNS', 'integer array of size (NSTRAT)', '0', """
