...
class GetDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.main_layout.addWidget(QLineEdit(), 3, 1, Qt.AlignCenter)
    ...
    def on_close(self):
        ...
        # SHOT, RUN, USER, MACINE, VERSION exclusively.
        try:
        ...
        MACHINE = self.main_layout.itemAt(6).widget().text()
        VERSION = self.main_layout.itemAt(7).widget().text()

        return SHOT, RUN, USER, MACHINE, VERSION
