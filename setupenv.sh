...
export PARAVIEW_PREFIX="${PWD}/staging/paraview/5.3.0"
...
export LD_LIBRARY_PATH="${PWD}/staging/qt/5.7.1/lib:${LD_LIBRARY_PATH}"
export PKG_CONFIG_PATH="${PWD}/staging/lib/pkgconfig:${PKG_CONFIG_PATH}"
export PYTHONPATH="${PWD}/src/widgets:${PYTHONPATH}"
export PYTHONPATH="${PWD}/staging/lib/site-packages:${PYTOHNPATH}"
