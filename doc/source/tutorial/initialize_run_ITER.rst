...
.. _initialize-run-ITER:


==================================
Initializing run for ITER baseline
==================================
...
.. note::
   ...
   inside ``$SOLPSTOP/runs/example/tutorial-DivGeo_ITER_baseline_scenario`` or
...
If you have finished with the previous tutorial :ref:`meshing-iter` then you
...
If you haven't done :ref:`meshing-iter`, do it, because you cannot continue
from this point.
