...
.. _initialize-run-compass:


=============================
Initializing run for COMPASS 
=============================
...
.. note::
   ...
   This tutorial should continue after the meshing tutorial :ref:`meshing-compass`
   inside ``$SOLPSTOP/runs/example/tutorial-DivGeo_Compass`` or
   start from the completed meshing example by entering the following command
   lines::

     $ stop
     $ cd runs/examples
     $ make tutorial-DivGeo_Compass-InitializeRun
     $ cd tutorial-DivGeo_Compass-InitializeRun
     $ rm -rf new_run # Will be created in this tutorial

   After you have extracted the case, be sure to select the *baserun* inside
   ``$SOLPSTOP/runs/example/tutorial-DivGeo_Compass-InitializeRun/``.
...
If you have finished with the previous tutorial :ref:`meshing-compass` then you
are set to initialize a run for C-Mod and thus finish preparing the case for
future simulations and runs with different settings.

If you haven't done :ref:`meshing-compass`, do it, because you cannot continue
from this point.
...
.. image:: Initialize_run_compass_1.png
   :align: center
...
default physics file, b2fpardf. Now here the should be an error that file 
`b2ah.dat` is not specific and  is missing in the baserun directory.
...
.. image:: Initialize_run_compass_4.png
   :align: center
...
.. image:: Initialize_run_compass_5.png
   :align: center
...
.. image:: Initialize_run_compass_6.png
   :align: center
...
.. image:: Initialize_run_compass_7.png
   :align: center
...
Now after some minutes it will finish and towards the end the output will look like


.. image:: Initialize_run_compass_8.png
   :align: center

.. image:: Initialize_run_compass_9.png
   :align: center
...
.. image:: Initialize_run_compass_10.png
   :align: center
